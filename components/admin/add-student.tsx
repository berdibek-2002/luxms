...
export const AddStudent = () => {
  ...
  const addList:any = () => {
    ...
    setIsLoading(true);
    axios
      .post('https://64f82e4b824680fd217f39b9.mockapi.io/students', {
        name,
        email,
        password,
        science,
  ...
  return (
    <div className='w-96 h-full bg-white mx-auto rounded-xl py-5 px-3'>
      <div>
